...
public class ReportHelper {
	...
	public static String toStringHeader_Standings() {
		return new StringBuffer()
			.append("Team | SOS    RPI     MOV     SRS   PW%  |")
			.toString();
	}
	
	public static String toString_Standings(Standing standing) {
		return new StringBuffer()
			.append(Utilities.padRight(standing.getTeamAbbr().toString(), 4))
			.append(" " + Utilities.padLeft(standing.getStrengthOfSchedule(3).toString(), 6))
			.append(" " + Utilities.padLeft(standing.getRelativePercentageIndex(3).toString(), 6))
			.append("  " + Utilities.padLeft(standing.getMarginOfVictory(1).toString(), 5))
			.append("  " + Utilities.padLeft(standing.getSimpleRatingSystem(2).toString(), 6))
			.append("  " + Utilities.padLeft(standing.getProjectedWinningPercentage(3).toString(), 5))
			.toString();
	}
	
	public static String toStringFooter_Standings() {
		return new StringBuffer()
			...
			.append("\r  " + Utilities.padRight("MOV: Margin of Victory", 40) + "(Team PTS - Oppt PTS) / GP")
